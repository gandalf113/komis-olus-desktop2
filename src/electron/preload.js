...
const WINDOW_API = {
    ...
    // Decrement
    decrementReturnedAmountBy: (itemId, amount) => ipcRenderer.invoke("decrement/returnedAmount", { itemId: itemId, amount: amount }),
    // Delete
    ...
    deleteReturn: (returnId) => ipcRenderer.invoke("delete/return", { returnId }),
}
